...
const Nav = () => {
    ...
    return (
      <nav className="flex justify-around p-4 bg-blue-100">
        <Link href="/">
        <div className={`group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-400 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 text-gray-900`}>
        ...
        <Link href="/about">
          <div className={`group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-400 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 text-gray-900 ${router.pathname !== "/about" ? "" : "group-hover:translate-x-1"}`}>
        ...
        <Link href="/exp">
          <div className={`group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-400 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 text-gray-900 ${router.pathname !== "/experience" ? "" : "group-hover:translate-x-1"}`}>
        ...
        <Link href="/projects">
          <div className={`group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-400 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 text-gray-900 ${router.pathname !== "/projects" ? "" : "group-hover:translate-x-1"}`}>
